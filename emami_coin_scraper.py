...
url = 'https://www.tgju.org/profile/sekee/history'
...
api_url = 'https://api.tgju.org/v1/market/indicator/summary-table-data/sekee'
...
df.to_csv('Tgju_emami_coin.csv', index=False, encoding='utf-8-sig')
