...
url = 'https://www.tgju.org/profile/ons/history'
...
api_url = 'https://api.tgju.org/v1/market/indicator/summary-table-data/ons'
...
df.to_csv('Tgju_ons_gold.csv', index=False, encoding='utf-8-sig')
